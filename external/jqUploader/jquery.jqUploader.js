 ...
 *
 * July 2007
 * Updated the selects in lines 29,36,62,70. Removed @ from front of vars to fix
 * fault with jqUploader not working with jQuery 1.3.x.  Get error
 * Syntax error, unrecognized expression: [@type='file']'
 *
 * LJP - SearchMasters
 *
 **/
 jQuery.fn.jqUploader = function(options) {
    return this.each(function(index) {
		...
		var opts = jQuery.extend({
				...
				src:    'external/jqUploader/jqUploader.swf',
